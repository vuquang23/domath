      ...
      <div class="row justify-content-center">
        <div class="col-7 quiz-page">
          ...
          <div v-if="page === 0">
            ...
            <iframe width="600" height="320" :src="quizz['tutorial']['src']" allow="autoplay"></iframe>
            </div>
          ...
          <!-- Heading -->
            ...
            <div v-if="check" style="margin-top: 2em;">
              ...
              <div v-if="viewSolution" style="margin-top: 0;">
                <iframe width="600" height="300" :src="quizz[`quiz-${page}`]['solution']['src']" allow="autoplay"></iframe>
              </div>
            </div>
          </div>
        </div>
